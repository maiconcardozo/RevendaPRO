...
namespace RevendaPro.Global.Application.Roles.DTOs
{
...
namespace RevendaPro.Global.Application.Roles.Queries
{
    using MediatR;
...
namespace RevendaPro.Global.Application.Roles.Commands
{
    using MediatR;
    using RevendaPro.Global.Application.Roles.DTOs;
...
namespace RevendaPro.Global.Application.Roles.Validators
{
    using FluentValidation;
...
namespace RevendaPro.Global.Application.Roles.Handlers
{
    using MediatR;
    using RevendaPro.Global.Application.Roles.Commands;
    using RevendaPro.Global.Application.Roles.DTOs;
